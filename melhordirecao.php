...
$games = [
    [
        'id' => 1,
        'title' => 'ASTRO BOT',
        'developer' => 'Team Asobi/SIE',
        'status' => 'closed',
        'image' => 'imagens/astro.avif'
    ],
    [
        'id' => 2,
        'title' => 'SILENT HILL 2',
    ...
    [
        ...
        'status' => 'closed',
        'image' => 'imagens/ff.jpg'
    ],
    [
        'id' => 6,
        'title' => 'METAPHOR: REFANTAZIO',
        'developer' => 'Studio Zero/Atlus/Sega',
        'status' => 'closed',
        'image' => 'imagens/metaphor.jpg'
    ],
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['voto_id'], $_POST['nome'])) {
    ...
    if (!empty($nomeUsuario) && !empty($gameTitle)) {
        ...
        $stmt = $pdo->prepare("INSERT INTO votos_melhordirecao (game_title, user_name, voted_at) VALUES (:game_title, :user_name, NOW())");
        $stmt->execute([
...
<body>
    <h1>Vote no Jogo com a Melhor Direção</h1>

    <!-- Botão próximo no topo -->
    <button class="next-button" onclick="window.location.href = 'melhordlc.php';">Próximo</button>
