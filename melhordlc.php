...
$games = [
    ...
    [
        ...
        'status' => 'closed',
        'image' => 'imagens/dlc2.webp'
    ],
    [
        'id' => 3,
        'title' => 'PERSONA 3 EPISODE AIGIS',
        'developer' => 'Atlus',
        'status' => 'closed',
        'image' => 'imagens/dlc3.jpg'
    ],
    [
        'id' => 4,
        ...
        'developer' => 'Remedy',
        'status' => 'closed',
        'image' => 'imagens/dlc4.webp'
    ],
    [
        'id' => 5,
        'title' => 'VAMPIRE SURVIVORS CASTLEVANIA',
        'developer' => 'Poncle',
        'status' => 'closed',
        'image' => 'imagens/dlc5.avif'
    ],
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['voto_id'], $_POST['nome'])) {
    ...
    if (!empty($nomeUsuario) && !empty($gameTitle)) {
        ...
        $stmt = $pdo->prepare("INSERT INTO votos_melhordlc (game_title, user_name, voted_at) VALUES (:game_title, :user_name, NOW())");
        $stmt->execute([
...
<body>
    <h1>Vote na Melhor DLC</h1>

    <!-- Botão próximo no topo -->
    <button class="next-button" onclick="window.location.href = 'melhorfamilia.php';">Próximo</button>
